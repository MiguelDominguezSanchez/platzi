...
// Me sirvió para guiarme 😉
// Al inicio no estaba seguro pero cuando vi tu solución era similar a la que pensaba 😉
// fidelp27
// fidelp27
// 9450 Puntos
// un mes

// Están muy buenas tus respuestas. Por ahí para no extenderme lo resolví así
...
// functionshowElement(obj) {
//   returnObject.entries(obj).forEach((element) => {
//     console.log(element);
//   });
// }
// showElement(obj);
...
// miguelatenciacanoles
// miguelatenciacanoles
// 4488 Puntos
// un mes

// Yo ahorré codigo en la pregunta del 2 + 2
...
Huy si es que a mi nunca se me ocurre na, fijate tu 